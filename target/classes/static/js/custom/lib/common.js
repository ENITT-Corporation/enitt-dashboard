...
(function($) {
	...
	Utils.Common.prototype = {
		...
		dateStrKr : function (data){
			...
			//return year+"년 "+monthStr+"월 "+dateStr+"일&nbsp;&nbsp;"+hourStr+"시 "+minutesStr+"분 "+secondsStr+"초";
			return year+"-"+monthStr+"-"+dateStr+"&nbsp;&nbsp"+hourStr+":"+minutesStr+":"+secondsStr;
		},
