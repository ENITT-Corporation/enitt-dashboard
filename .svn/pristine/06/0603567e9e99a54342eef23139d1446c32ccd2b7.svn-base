...
public class EventController {
	...
	*/ 
	...
	/**
	  * @Method_Name : ajaxStatePopupOpen
	  * @return :ModelAndView
	  * @Date : 2022. 08. 22.
	  * @Author : ENITT_KHR
	  * @Method_Description : 이벤트 이력 - 상태 변경 팝업 노출
	  * ---------------------
	  * @변경이력
	  * 2022. 08. 22. ENITT_KHR : 생성
	  */
	@RequestMapping("/content/ajaxStatePopupOpen")
	public @ResponseBody ModelAndView ajaxStatePopupOpen(CommonVO vo) throws Exception {
		ModelAndView mav = new ModelAndView();
		...
		mav.addObject("commonVO", vo);
		mav.setViewName("event/content/popup");
		return mav;
	}
}
